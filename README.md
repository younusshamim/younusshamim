...
#### Skills: 
- **Experts**: JavaScript, ES6, React JS, React Router, React Bootstrap, Styled Component, HTML, Modern CSS, Bootstrap, jQuery, Rest API, Context API, Firebase
- **Comfortable**: Next JS
- **Familiar**: Redux, MongoDB
